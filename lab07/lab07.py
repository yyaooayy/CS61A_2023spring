...
class Person:
    ...
    def __init__(self, name):
        self.name = name
        self.last_talk = 'I squirreled it away before it could catch on fire.'

    def say(self, stuff):
        self.last_talk = stuff
        return stuff
...
class SmartFridge:
    ...
    def use_item(self, item, quantity):
        ...
        self.items[item] -= quantity
        return 'I have {0} Mayo left'.format(self.items[item])
