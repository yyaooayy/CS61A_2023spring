...
def tail_points(opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    ones_digits = opponent_score % 10
    tens_digits = (opponent_score // 10) % 10
    return 2 * abs(tens_digits - ones_digits) + 1
    # END PROBLEM 2
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            # print('DEBUG: score0 is', score0)
            who = 1
        else:
            score1 = update(strategy1(score1, score0), score1, score0, dice)
            # print('DEBUG: score1 is', score1)
            who = 0
    # END PROBLEM 5
...
def make_averaged(original_function, total_samples=1000):
    ...
    def average_value(*args):
        ...
        while loop_counter < total_samples:
            sum = original_function(*args) + sum
            loop_counter += 1
        output = sum / total_samples
        return output
